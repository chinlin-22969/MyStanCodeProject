...
class BreakoutGraphics:
    ...
    def game_over(self):
        ...
        game_over.font = '-80'
        game_over.color = 'red'
        self.window.add(game_over, x=(self.window.width-game_over.width)/2, y=(self.window.height-game_over.height)*2/3)
        return game_over
    ...
    def make_cubes(self):
        ...
        cube1 = GRect(20, 20)
        cube1.filled = 'True'
        cube1.fill_color = 'darkred'
        cube1.color = 'darkred'
        # paddle shortened
        cube2 = GRect(20, 20)
        cube2.filled = 'True'
        cube2.fill_color = 'slategrey'
        cube2.color = 'slategrey'
        if n == 1:
