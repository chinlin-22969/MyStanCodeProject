...
class BreakoutGraphics:
    def __init__(self, ball_radius=BALL_RADIUS, paddle_width=PADDLE_WIDTH, paddle_height=PADDLE_HEIGHT,
        ...
        # WINDOW: Create a graphical window, with some extra space
        window_width = brick_cols * (brick_width + brick_spacing) - brick_spacing
        window_height = brick_offset + 3 * (brick_rows * (brick_height + brick_spacing) - brick_spacing)
        self.window = GWindow(width=window_width, height=window_height, title=title)

        # BRICKS: set bricks size
        self.draw_brick()
        self.b_r = BRICK_ROWS
        self.b_c = BRICK_COLS
        self.counter = 0  # how many times the ball hits the brick

        # PADDLE: Create a paddle
        ...
        # BALL: Center a filled ball in the graphical window
        self.ball = GOval(ball_radius*2, ball_radius*2)
        self.ball.filled = 'True'
        self.window.add(self.ball, x=(window_width-ball_radius*2)/2, y=(window_height-ball_radius*2)/2)

        # BALL MOVE: Default initial velocity for the ball
        self.__dx = 0
        self.__dy = 0

        # MOUSE: Initialize our mouse listeners
        ...
        # OTHERS: To put the obj you want ball to ignore(ex: cubes, label)
    ...
    # PADDLE: Paddle moves with the mouse
    ...
    # BALL: Be triggered when click mouse
    ...
    # BALL: Ball reset, when minus a life
    def reset_ball(self):
    ...
    # BALL MOVE: In case when ball hit the brick/ paddle/ window
    def get_dx(self):
        return self.__dx
    ...
    # CUBES: Make cubes and methods when the paddle catch the cubes(paddle expand and shorten)
    def make_cubes(self):
    ...
    # BALL vs BRICK vs CUBE: when ball meet brick, ball rebound, make cubes and append it to cubes lst
    ...
    # END: Show label "GAME OVER" or "You WIN!!!"
    def game_over(self):
    ...
    def win_game(self):
        ...
        self.window.add(win, x=(self.window.width - win.width) / 2,
                        y=(self.window.height - win.height) * 3 / 4)
        return win
